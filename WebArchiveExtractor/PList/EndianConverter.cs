...
namespace WebArchiveExtractor.PList
{
    ...
    public static class EndianConverter
    {
        ...
        {
            return (uint) (((SwapUInt16((ushort) value) & 0xffff) << 0x10) |
                           (SwapUInt16((ushort) (value >> 0x10)) & 0xffff));
        }
        ...
        {
            return (ulong) (((SwapUInt32((uint) value) & 0xffffffffL) << 0x20) |
                            (SwapUInt32((uint) (value >> 0x20)) & 0xffffffffL));
        }
        #endregion

        #region ToBigEndianConditional
        /// <summary>
        ...
        #region ToLittleEndianConditional
        /// <summary>
        ...
        {
            return BitConverter.IsLittleEndian ? value : value.SwapEndian();
        }
